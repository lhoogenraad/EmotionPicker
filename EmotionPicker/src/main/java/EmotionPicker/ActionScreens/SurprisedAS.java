...
import static EmotionPicker.ActionScreens.AngryAS.addListener;
 ...
 * @author The Gibbon
 */
public class SurprisedAS  extends JPanel implements ActionScreen {
    private static JFrame frame, endFrame = new JFrame();
    Border bl = BorderFactory.createLineBorder(Color.black);
    public SurprisedAS(JFrame parentFrame) {

        frame = parentFrame;
        String title = "I am surprised, so I want to...";
    ...
    public static void addListener(JLabel label, int selector){
        label.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e){
                ...
                frame.dispose();
                endFrame.getContentPane().add(new EndScreen("surprised", labelText));
